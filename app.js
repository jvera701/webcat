...
function report (data){
  ...
  for (let i=0; i< data.length; i++){
    ...
    if (agg.byCountry[country])
      agg.byCountry[country] += 1
    else
      agg.byCountry[country] = 1
    
    if (agg.byVehicle[vehicle])
      agg.byVehicle[vehicle] += 1
    else
      agg.byVehicle[vehicle] = 1
    ...
    else if (years <=29 && years > 18)
      agg.byAgeRanges['19-29'] += 1
    
    else if (years <=45 && years > 29)
      agg.byAgeRanges['30-45'] += 1
    
    else if (years <=70 && years > 45)
      agg.byAgeRanges['46-70'] += 1
    
    else
      agg.byAgeRanges['>70'] += 1
